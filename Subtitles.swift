...
public extension AVPlayerViewController {
    ...
    fileprivate func addSubtitleLabel() {
        ...
        guard let _ = subtitleLabel else {
            ...
            subtitleView.backgroundColor = UIColor.black
...
//            subtitleLabel?.font = UIFont.boldSystemFont(ofSize: UI_USER_INTERFACE_IDIOM() == .pad ? 50.0 : 30.0)
//            subtitleLabel?.textColor = UIColor.red
//            subtitleLabel?.layer.shadowColor = UIColor.black.cgColor
//            subtitleLabel?.layer.shadowOffset = CGSize(width: 1.5, height: 1.5);
...
//            subtitleLabel?.layer.rasterizationScale = UIScreen.main.scale
            ...
            subtitleView.addConstraints(constraints)
            constraints = NSLayoutConstraint.constraints(withVisualFormat: "V:|-15-[l]", options: NSLayoutFormatOptions(rawValue: 0), metrics: nil, views: ["l" : subtitleLabel!])
            subtitleView.addConstraints(constraints)
            ...
            subtitleView.addConstraint(subtitleLabelHeightConstraint!)
            
//            let top = NSLayoutConstraint(item: subtitleView,
//                                         attribute: .top,
//                                         relatedBy: .equal,
//                                         toItem: contentOverlayView,
//                                         attribute: .top,
//                                         multiplier: 1.0,
//                                         constant: 0.0)
//            let bottom = NSLayoutConstraint(item: subtitleView,
//                                         attribute: .bottom,
//                                         relatedBy: .equal,
//                                         toItem: contentOverlayView,
//                                         attribute: .bottom,
//                                         multiplier: 1.0,
//                                         constant: 0.0)
//            let width = NSLayoutConstraint(item: subtitleView,
//                                            attribute: .width,
//                                            relatedBy: .equal,
//                                            toItem: contentOverlayView,
//                                            attribute: .width,
...
//                                            constant: 0.0)
//
//            contentOverlayView?.addConstraint(top)
//            contentOverlayView?.addConstraint(bottom)
//            contentOverlayView?.addConstraint(width)
            ...
            let width = NSLayoutConstraint(item: subtitleView,
                                           ...
                                           multiplier: 1.0,
                                           constant: 0.0)
            let height = NSLayoutConstraint(item: subtitleView,
                                           attribute: .height,
                                           relatedBy: .equal,
                                           toItem: contentOverlayView,
                                           attribute: .height,
            ...
            contentOverlayView?.addConstraint(bottom)
            contentOverlayView?.addConstraint(width)
            contentOverlayView?.addConstraint(height)
